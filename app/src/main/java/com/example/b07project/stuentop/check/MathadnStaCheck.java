...
public class MathadnStaCheck extends AppCompatActivity {
    EditText a67,a31,a48,a22,a37,a08,cr;
    CheckBox fin;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mathadn_sta_check);

    }

    public void  matgb(View view){
        Intent x=new Intent(getApplicationContext(), checkpost.class);
        startActivity(x);
    }

    public  void  matcp(View view){
        //TextView res=findViewById(R.id.msresult);
        ...
        if (!isdone){
            ...
            if (x.checkvalid1(done)&&x.checkvalid2(g31,g67,g08,g22,g37,g48,"MS")){
