...
import com.example.b07project.stuentop.StudentViewEventAdapter;
import com.example.b07project.stuentop.StudentViewEventModel;
...
public class AdminViewEvent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comAdapter = new StudentViewEventAdapter(this, usersList);
