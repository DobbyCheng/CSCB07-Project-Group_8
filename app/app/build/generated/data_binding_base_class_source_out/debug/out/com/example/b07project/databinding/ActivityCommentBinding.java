...
public final class ActivityCommentBinding implements ViewBinding {
  ...
  @NonNull
  public final EditText feedbackeventname;
  ...
  private ActivityCommentBinding(@NonNull ConstraintLayout rootView, @NonNull Button button,
      @NonNull Button button2, @NonNull EditText editTextNumber,
      @NonNull EditText editTextTextMultiLine, @NonNull EditText feedbackeventname,
    ...
    this.feedbackeventname = feedbackeventname;
  ...
  public static ActivityCommentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.feedbackeventname;
      EditText feedbackeventname = ViewBindings.findChildViewById(rootView, id);
      if (feedbackeventname == null) {
        break missingId;
      }
      ...
      return new ActivityCommentBinding((ConstraintLayout) rootView, button, button2,
          editTextNumber, editTextTextMultiLine, feedbackeventname, textView, textView2, textView3,
          textView4);
    }
